...
public class EditImageActivityTest {
  ...
  @Rule
  public ActivityTestRule<EditImageActivity> mActivityRule =
      new ActivityTestRule<>(EditImageActivity.class, false, false);
  ...
  public void testShareIntentWhenImageIsAvailableOnClickedOnShareButton()
